...
class CalculadoraMatematicaAvanzada extends Calculadora{
    ...
    derivada() {
        var arg1 = this.pila.pop();
        var resultado = Math.derivative(Math.parse(arg1), 'x');
        if (isNaN(resultado)) {
            alert("No se puede realizar esta operación con el estado actual de la pila.");
            if (!isNaN(arg1)) {
                this.pila.push(arg1);
...
var cal = new CalculadoraMatematicaAvanzada();
